...
from multicolorcaptcha import CaptchaGenerator # type: ignore
from jokes import getJoke
from telegram import Bot
from telegram.ext import Updater # type: ignore

updater = updater = Updater(token='7332076284:AAF7eo9mwafIAoiOggt9nOzMXV2fU_km7lQ', request_kwargs={'read_timeout': 10, 'connect_timeout': 10})
...
if "COIN_SYMBOL" in os.environ:
    print("COIN_SYMBOL is loaded:", os.environ["COIN_SYMBOL"])
else:
    print("COIN_SYMBOL not found in environment variables")

# Now you can access the environment variables
COIN_SYMBOL = os.environ.get("COIN_SYMBOL", "default_value")  # Add a default value if not found
